  ...
  <div>
    ...
    <div class="container mx-auto p-6 mt-6">
      ...
      <div class="card shadow-sm mb-6">
        ...
        <div class="card-body">
          <table class="table table-hover table-responsive" v-if="filteredTransactions.length > 0">
            ...
            <tbody>
              <tr v-for="transaction in filteredTransactions" :key="transaction.idTransaction"
                ...
                <td>
                  ...
                  <button class="btn btn-info btn-sm" @click="showDetails(transaction.idTransaction)">
                    View Proof
                  </button>
                </td>
              </tr>
      ...
      <div v-if="isModalOpen" class="custom-modal">
        <div class="custom-modal-content">
          ...
          <div v-else>
            ...
            <div v-if="selectedTransaction.buktiTransfer" class="text-center mt-3">
              <h5>Payment Proof</h5>
              <img :src="`data:image/jpeg;base64,${selectedTransaction.buktiTransfer}`" alt="Proof of Payment"
            ...
            <div class="mt-4">
              ...
              <textarea id="notes" v-model="selectedTransaction.notes" <!-- Bind to notes from selectedTransaction -->
      class="form-control"
      rows="4"
      placeholder="Enter your notes here..."
      readonly <!-- Optionally make it readonly after admin updates it -->
    ></textarea>
            </div>

            <!-- Conditionally show 'Accept' and 'Decline' buttons in modal if status is 'WAITING FOR APPROVAL' -->
            <div v-if="selectedTransaction.paymentStatus === 'WAITING FOR APPROVAL'"
