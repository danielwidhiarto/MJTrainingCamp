    ...
    async addPackage() {
      ...
      try {
        const response = await axios.post(
          'http://https://ec2-13-229-129-198.ap-southeast-1.compute.amazonaws.com/api/v1/package/add',
          this.currentPackage,
          {
            headers: {
    ...
    async updatePackage() {
      ...
      try {
        const response = await axios.put(
          `http://https://ec2-13-229-129-198.ap-southeast-1.compute.amazonaws.com/api/v1/package/update/${this.currentPackage.id}`,
          this.currentPackage,
          {
            headers: {
              'Content-Type': 'application/json',
    ...
    async deletePackage(packageId) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          try {
            await axios.delete(
              `http://https://ec2-13-229-129-198.ap-southeast-1.compute.amazonaws.com/api/v1/package/delete/${packageId}`,
              {
                headers: {
                  Authorization: `Bearer ${this.token}`,
                },
