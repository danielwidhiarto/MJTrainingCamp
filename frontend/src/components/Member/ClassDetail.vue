    ...
    async fetchClassDetail() {
      ...
      try {
        const response = await axios.get(
          `http://ec2-13-229-129-198.ap-southeast-1.compute.amazonaws.com/api/v1/class/getClasses?id=${idClass}`,
          {
    ...
    async handleJoinClass() {
      ...
      try {
        ...
        const eligibilityResponse = await axios.post(
          'http://ec2-13-229-129-198.ap-southeast-1.compute.amazonaws.com/api/v1/class/check-eligibility',
          {
            idClass: idClass,
            token: token,
          },
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          try {
            ...
            await axios.post(
              'http://ec2-13-229-129-198.ap-southeast-1.compute.amazonaws.com/api/v1/class/book',
              {
